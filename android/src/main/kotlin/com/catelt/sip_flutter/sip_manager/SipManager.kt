...
internal class SipManager private constructor(context: Context) {
    ...
    private fun initSipAccount(sipConfiguration :SipConfiguration) {
        ...
        val authInfo =
            Factory.instance().createAuthInfo(username, null, sipConfiguration.password, null, null,domain, null)
    ...
    fun call(recipient: String, result: Result) {
        ...
        val remoteAddress = Factory.instance().createAddress("sip:$recipient")
